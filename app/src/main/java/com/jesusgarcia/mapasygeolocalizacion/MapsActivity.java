package com.jesusgarcia.mapasygeolocalizacion;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnUbicacionActual.setOnClickListener(this);
    }


    /*Verifica si los permisos han sido concedidos por el usuario y regresa un valor booleano
      (falso o verdadero) dependiendo de si el permiso fue permitido o negado
    */
    ...
    public void onClick(View v) {
        if (v.equals(btnUbicacionActual)) {
            mMap.clear();
            markerPoints.clear();
        }
